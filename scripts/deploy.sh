...
main() {
    ...
    for _file in /tmp/artifacts/*; do
        ...
        echo "curl -sSL -X POST \"$_upload_url?name=$_basename\" -H \"Accept: application/vnd.github.manifold-preview\" -H \"Authorization: token $GITHUB_TOKEN\" -H \"Content-Type: $_mimetype\" --data-binary \"@$_file"
